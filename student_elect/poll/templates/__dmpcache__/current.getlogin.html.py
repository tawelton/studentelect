...
_magic_number = 10
_modified_time = 1553996417.338685
_enable_loop = True
...
def render_content(context,**pageargs):
    ...
    try:
        ...
        __M_writer('" id="studentForm">\n                <div class="card">\n                  <div class="card-body">\n                    <input type="text" class="form-control" required=true id="studentID_id" name="studentID" placeholder="Student ID">\n                    <button type="submit" class="btn btn-submit" id="loginButton">Sign In</button>\n                  </div>\n                </div>\n              </form>\n            </div>\n        </div>\n  </div>\n\n    \n\n\n')
        return ''
    finally:
        context.caller_stack._pop_frame()
...
"""
__M_BEGIN_METADATA
{"filename": "/Users/tannerwelton/Documents/OneDrive - BYU Office 365/Projects/student_elect/student_elect/poll/templates/current.getlogin.html", "uri": "current.getlogin.html", "source_encoding": "utf-8", "line_map": {"29": 0, "41": 1, "46": 3, "51": 25, "57": 3, "68": 5, "77": 5, "78": 10, "79": 10, "80": 10, "81": 10, "87": 81}}
__M_END_METADATA
"""
